...
require_text .github/workflows/ci.yml 'e7206008316ccc5c5d20f67559b3e7a6c1f781d2'
require_text .github/workflows/ci.yml 'gh repo clone bignormal/aera-cloud'
require_text .github/workflows/ci.yml 'cd "\$bridge_root"'
require_text .github/workflows/ci.yml 'AERA_SCHEMA22_MIGRATION_FILE'
forbid_text .github/workflows/ci.yml 'filter=blob:none'
