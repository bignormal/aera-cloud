...
func seedOfficialQualityProvenance(
	...
	qualityExec(t, ctx, tx, `INSERT INTO platforms (id, platform_key, display_name, status, created_at, updated_at) VALUES ($1, $2, 'Aera Official', 'active', $3, $3)`, fixture.platformID, "quality_"+fixture.platformID.String()[:8], now)
